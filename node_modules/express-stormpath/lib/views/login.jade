...
block vars
  - var title = 'Ingresar'
  - var description = 'Ingresa a tu Cuenta'
  - var bodytag = 'login'
        ...
        .box.row
          ...
          div(class='email-password-area col-xs-12 #{cls}')
            ...
            form.login-form.form-horizontal(method='post', role='form',action=formActionUri)
              ...
              p
              label(for='idEmpresa',class='padding-right: 24%') Empresa
              select(name='idEmpresa')
                each val, index in {0:'CGE',1:'Copelec',2:'Frontel',3:'SAESA',4:'Transelec'}
              ...
              div
                button.login.btn.btn-login.btn-sp-green(type='submit') Ingresar
